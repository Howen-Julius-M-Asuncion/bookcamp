...
<body>
    <?php
        // Check if 'success' parameter is set in the URL and store it in a session
        if (isset($_GET['success']) && $_GET['success'] == 'true') {
            $_SESSION['success'] = true;
            // Redirect to remove 'success' from the URL and prevent the alert from showing after refresh
        ...
        if (isset($_SESSION['success']) && $_SESSION['success'] === true) {
            ...
            // Unset success flag after showing the alert
    ...
    <div class="container-fluid">
        ...
        <!-- Edit Entry Modal -->
        <form method="post" action="./user_mngmt.php" id="editEntryForm">
